...
#define ALL_FLAG FLAG_CLASS|FLAG_LAYER

#define GET_BODY(code) ((code) & (~ALL_FLAG))
#define HAS_CLASS_FLAG(code) ((code) & FLAG_CLASS)
#define HAS_LAYER_FLAG(code) ((code) & FLAG_LAYER)

#define IS_REFERNCE(code) (HAS_CLASS_FLAG(code) && !HAS_LAYER_FLAG(code))
#define IS_CLASS(code) (!HAS_CLASS_FLAG(code) && !HAS_LAYER_FLAG(code))
#define IS_LAYER(code) (!HAS_CLASS_FLAG(code) && HAS_LAYER_FLAG(code))
#define IS_KEYBASED(code) (HAS_CLASS_FLAG(code) && HAS_LAYER_FLAG(code))
...
#define COLOR_COLEMAK {.r = 0x17, .g = 0x09, .b = 0x0A}
...
const RGB layer_colors[] = {
    [_QWERTY] = {.r = 0x1d, .g = 0x0a, .b = 0x2d},
    [_NUM] =    {.r = 0x07, .g = 0x19, .b = 0x18},
    [_ARR] =    {.r = 0x20, .g = 0x18, .b = 0x05},
    [_SYM] =    {.r = 0x16, .g = 0x33, .b = 0x00},
    [_ZER] =    COLOR_COLEMAK,
    [_ONE] =    COLOR_COLEMAK,
    [_TWO] =    COLOR_COLEMAK,
    [_TRE] =    COLOR_COLEMAK,
